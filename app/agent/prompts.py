...
SYSTEM_MESSAGE = SystemMessage(
    content=(
        ...
        "Always CALL search_vehicles before saying anything about inventory. Never say you don't have vehicles before searching. Never invent vehicles. "
        ...
        "The moment the customer mentions ANY date or time (e.g. 'tomorrow', 'Friday', '3pm', 'next week') — that is the confirmed time. CALL book_appointment immediately. Do NOT reply with text first. Do NOT ask for confirmation. Just call the tool. "
